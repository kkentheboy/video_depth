...
set DEPTH_FUSION_VERBOSE_THIRD_PARTY=1

if not exist ".venv\Scripts\python.exe" (
  echo [ERROR] .venv not found. Run SETUP_ENV_MIGRATE_COMPLETE.bat first.
  pause
  exit /b 1
)
...
echo [INFO] Launching GUI with full event console...
