...
class MainWindow(ResourceManagementMixin, FilePathActionsMixin, InputValidationMixin, ProcessingRangeMixin, PreviewFrameMixin, ProjectStateMixin, JobConfigurationMixin, OutputRoutingMixin, QMainWindow):
