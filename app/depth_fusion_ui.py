...
class MainWindow(ResourceManagementMixin, FilePathActionsMixin, ProcessingRangeMixin, ProjectStateMixin, JobConfigurationMixin, OutputRoutingMixin, QMainWindow):
