...
class MainWindow(ResourceManagementMixin, FilePathActionsMixin, InputValidationMixin, ModelConfigurationMixin, ProcessingRangeMixin, PreviewFrameMixin, ProjectStateMixin, JobConfigurationMixin, OutputRoutingMixin, QMainWindow):
